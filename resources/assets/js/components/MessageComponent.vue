        ...
        <div class="card-header">
            ...
            <div class="dropdown float-right mr-4">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="#" v-if="session.block" @click.prevent="unblock">UnBlock</a>
...
export default {
  ...
  computed: {
    ...
    can() {
      return this.session.blocked_by == this.id;
    }
  },
  watch: {
    message(value) {
  ...
  methods: {
    ...
    block() {
      ...
      axios
        ...
        .then(res => (this.session.blocked_by = this.id));
    },
    unblock() {
